            ...
            <div className="relative max-w-md mx-auto lg:mx-0">
              ...
              <div className="relative aspect-[3/4] overflow-hidden rounded-2xl group">
                <motion.img
                  ...
                  loading="lazy"
                  className="w-full h-full object-cover about-img transition-[filter] duration-700 scale-110"
                  style={{ y: imgY }}
                />
                <div className="absolute inset-0 bg-gradient-to-t from-bg via-transparent to-transparent img-overlay-dark-strong opacity-70" />
